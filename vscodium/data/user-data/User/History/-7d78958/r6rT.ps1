...
# Define a function to delete and discard a file using git rm --cached command
function Delete-File {
    param (
        [Parameter(Mandatory=$true)]
        [string]$File # The file path to delete
    )
    ...
    # Delete and discard the file using git rm --cached command
    git rm --cached $File
