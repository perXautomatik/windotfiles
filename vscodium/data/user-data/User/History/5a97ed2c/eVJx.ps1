...
Describe "Get-TridChunks" {
  ...
  It "should return two chunks of paths for trid for a valid input with two chunks" {
    ...
    $Paths = @("C:\foo\bar1.txt", "C:\foo\bar2.txt", "C:\foo\baz1.txt", "C:\foo\baz2.txt","C:\foo\bax1.txt", "C:\foo\bax2.txt", "C:\foo\bay1.txt", "C:\foo\bay2.txt")
    $ChunkSize = 2
    $ExpectedOutput = @("C:\foo\bar*", "C:\foo\baz*","C:\foo\bax*", "C:\foo\bay*")
