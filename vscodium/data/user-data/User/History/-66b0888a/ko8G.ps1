...
"@        
    ...
    It 'Splits the text by whitespace and returns the matches' {
        ...
        $output[10].StartIndex | Should -Be 55 # Check that the last match starts at index 62
        $output[10].EndIndex | Should -Be 55 # Check that the last match ends at index 62
