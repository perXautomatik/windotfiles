...
$folderPath = "K:\D2RMM 1.4.5\mods\"
install-module pseverything ; Import-Module pseverything ; Search-Everything -PathExclude "B:\pf\" -Filter '<wholefilename:child:.git file:>|<wholefilename:child:.git folder:>' -global

# Use Everything to find all folders in the folder path
$folders = es -PathExclude $folderPath -Filter '<wholefilename:child:.git file:>|<wholefilename:child:.git folder:>' -global
