...
$folderPath = "B:\PF\Modding\Diablo II ressurected"
install-module pseverything ;
 Import-Module pseverything ; 


# Use Everything to find all folders in the folder path
$folders =  Search-Everything  -PathInclude $folderPath -Filter '<wholefilename:child:.git file:>|<wholefilename:child:.git folder:>' -global
...
foreach ($folder in $sortedFolders) {
    ...
    $xq = incoke-expression "git diff --cached --quiet"
