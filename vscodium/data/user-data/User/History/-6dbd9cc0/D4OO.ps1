...
$success_content = [System.Collections.Hashtable][Linq.Enumerable]::ToLookup($success_results, [Func[object,object]] { param($r) $r.RepoName }, [Func[object,object]] { param($r) Get-Content $r.GitFile })
