...
$success_results = [Linq.Enumerable]::Where($results, [Func[object,bool]] { param($r) $r.Success -notmatch $f -and $r.Success -ne "" })
...
$success_content = $success_content.GetEnumerator() | ? {$_.value -ne "gitdir: " }
