...
function Get-GitStatus {
    ...
    param (
        ...
        # Check if the RepoPath exists and is a directory
        if (Test-Path $RepoPath -PathType Container) {
            ...
            # Throw an error if the RepoPath does not exist or is not a directory
            throw "Invalid directory. The RepoPath '$RepoPath' does not exist or is not a directory."
        }
    ...
    try {
        ...
        try {
            ...
            try {
                ...
                try {
                    $success = Get-GitStatus $repo_path $_
