...
function Move-Files {
  ...
  foreach ($Entry in $List) {
      ...
      Get-ChildItem -Path $Path | Move-Item -Destination $NewFolder -WhatIf
  }
}

$listx = $uu | ?{ $_.parent -in $InsideOrNeither} | select name, @{name="path"; e={Split-Path -Path $_.parent -leaf}}
