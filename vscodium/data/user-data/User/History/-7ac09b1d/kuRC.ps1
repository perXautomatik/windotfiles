...
function get-Relative {
	...
	function about-Repo()
	{
				...
				# Write some information to the console
			Write-Verbos '************************************************************' -Verbose: ($PSCmdlet.MyInvocation.BoundParameters [\"Verbose\"].IsPresent -eq $true)
			Write-Verbos $targetFolder.ToString() -Verbose: ($PSCmdlet.MyInvocation.BoundParameters [\"Verbose\"].IsPresent -eq $true)
			Write-Verbos $name.ToString() -Verbose: ($PSCmdlet.MyInvocation.BoundParameters [\"Verbose\"].IsPresent -eq $true)
			Write-Verbos $path.ToString() -Verbose: ($PSCmdlet.MyInvocation.BoundParameters [\"Verbose\"].IsPresent -eq $true)
			Write-Verbos $configFile.ToString() -Verbose: ($PSCmdlet.MyInvocation.BoundParameters [\"Verbose\"].IsPresent -eq $true)
			Write-Verbos '************************************************************'-Verbose: ($PSCmdlet.MyInvocation.BoundParameters [\"Verbose\"].IsPresent -eq $true)
		}
	}
}
