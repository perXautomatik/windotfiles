  ...
  skillsJson.push(
    {
      "id": 80002,
      "Key": "StrSkill80002",
      "enUS": "%d bone spear", "zhTW": "%d bone spear", "deDE": "%d bone spear", "esES": "%d bone spear", "frFR": "%d bone spear", "itIT": "%d bone spear", "koKR": "%d bone spear", "plPL": "%d bone spear", "esMX": "%d bone spear", "jaJP": "%d bone spear", "ptBR": "%d bone spear", "ruRU": "%d bone spear", "zhCN": "%d bone spear"
    }
  ...
  skillsJson.push(
    {
      ...
      "enUS": "Resist Magic: %+d%%", "zhTW": "Resist Magic: %+d%%", "deDE": "Resist Magic: %+d%%", "esES": "Resist Magic: %+d%%", "frFR": "Resist Magic: %+d%%", "itIT": "Resist Magic: %+d%%", "koKR": "Resist Magic: %+d%%", "plPL": "Resist Magic: %+d%%", "esMX": "Resist Magic: %+d%%", "jaJP": "Resist Magic: %+d%%", "ptBR": "Resist Magic: %+d%%", "ruRU": "Resist Magic: %+d%%", "zhCN": "Resist Magic: %+d%%"
    }
  );
}
