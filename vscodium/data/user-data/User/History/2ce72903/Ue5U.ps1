The script is already written as a function with a parameter check and synopsis. I can try to improve the script by adding some comments and error handling. Here is my attempt:
