...
$hardcodedPaths = 'C:\tools\poshgit\dahlbyk-posh-git-9bda399\src\posh-git.psd1' ,'C:\ProgramData\chocolatey\lib\git-status-cache-posh-client\tools\git-status-cache-posh-client-1.0.0\GitStatusCachePoshClient.psm1', 'C:\ProgramData\chocolatey\lib\BigGit\tools\BigGit\BigGit.psm1', $pos, $ChocolateyProfile
