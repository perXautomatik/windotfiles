...
& dolt table import -c -f armor1 $file1 --file-type=psv --delim="'  '"
...
& dolt table import -c -f armor2 $file2 --file-type=psv --delim="'  '"
...
Invoke-Expression “dolt sql -q ‘SELECT * FROM dolt_commit_diff_armor1‘”