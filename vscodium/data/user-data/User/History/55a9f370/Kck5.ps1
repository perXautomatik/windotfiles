# Import the module that contains the Sort-UsingDirectivesAndFunctions function
Import-Module -Name 'B:\PF\Archive\ps1\workflow\Beyond compare interaction\HelperScript\csharp-sort.ps1'
...
Invoke-Pester -ScriptBlock { . .\SortUsingDirectivesAndFunctions.Tests.ps1 } -Output Detailed
