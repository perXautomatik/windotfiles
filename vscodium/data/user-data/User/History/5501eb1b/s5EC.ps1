...
function Search-Everythingx {
    ...
    $filter = 'child:config count:1'
    $results =  Search-Everything  -PathInclude $folderPath -Filter $filter -global
...
if ($gitFileExists) {
    ...
    $firstResult = Search-Everythingx -FolderName $workFolderName
