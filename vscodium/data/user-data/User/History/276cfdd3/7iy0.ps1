...
$results = $results | ? { $_.FunctionName.type -eq "CommandArgument"} | select @{n="functionName"; e={$_.FunctionName.content}},@{n="FileLocation"; e={$_.FileLocation.resolvedTarget}} | Sort-Object FunctionName, FileLocation
