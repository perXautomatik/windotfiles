...
foreach ($file in $files) {
    ...
    $groups = $ends | select start, @{name = "end" ; e={Find-GroupStart -groupend $_.start -Tokens $tokenz}} 

    $res =  $groups | select start,end, @{ name = "functionBody" ; e={ Get-GroupContent -GroupStart $_.start -GroupEnd $_.end -Tokens $tokenz } }
