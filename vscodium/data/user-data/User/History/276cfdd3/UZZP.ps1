...
foreach ($file in $files) {
    ...
    $tokens, $errors = [System.Management.Automation.PSParser]::Tokenize($content, [ref]$null)
    ...
    foreach ($functionToken in $functionTokens) {
      ...
      $endToken = $tokens | Where-Object { $_.Type -eq 'End' -and $_.Start -gt $functionToken.Start } | Select-Object -First 1
