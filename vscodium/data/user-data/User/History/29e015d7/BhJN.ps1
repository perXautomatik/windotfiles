...
try {
    ...
    $to = CloneWithReference -repo $repo -objectRepo $repo -path $folderPath  -erroraction silentlycontinue
...
foreach ($file in $files) {
    ...
    try {
        ...
        #$f = "$file"
        cherryPick-byPattern -pattern $file -erroraction silentlycontinue
